...
import sty from "./PlasmicCopyrightSocialLanguage.module.css"; // plasmic-import: P1RVDzFnZQsG/css
import TwitterIcon from "./icons/PlasmicIcon__Twitter"; // plasmic-import: rfCoNybb2wM9/icon
import YoutubeIcon from "./icons/PlasmicIcon__Youtube"; // plasmic-import: zAd7rNWjgm9N/icon
import PintrestIcon from "./icons/PlasmicIcon__Pintrest"; // plasmic-import: emSvWZiGa3GN/icon
import Icon15Icon from "./icons/PlasmicIcon__Icon15"; // plasmic-import: mwH0WtyaDJrg/icon
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__kA12A)}
      >
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__pVo16)}
        >
          <div
            className={classNames(
              projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__fmcl2)}>
            <PlasmicLink__
              className={classNames(
                projectcss.all,
                projectcss.a,
            ...
            >
              <TwitterIcon
                className={classNames(projectcss.all, sty.svg__akKdu)}
                role={"img"}
              />
            </PlasmicLink__>
            <PlasmicLink__
            ...
            >
              <YoutubeIcon
                className={classNames(projectcss.all, sty.svg__biOz)}
                role={"img"}
              />
            </PlasmicLink__>
            <PlasmicLink__
            ...
            >
              <PintrestIcon
                className={classNames(projectcss.all, sty.svg__wpInA)}
                role={"img"}
              />
            </PlasmicLink__>
          </div>
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___3WgGi)}
        >
          <div
            className={classNames(
              projectcss.all,
          ...
          <Icon15Icon
            className={classNames(projectcss.all, sty.svg__h6Vj)}
            role={"img"}
          />
        </Stack__>
      </Stack__>
