...
import Price from "../../Price"; // plasmic-import: R6EJCXXuB-lk/component
import "@plasmicapp/react-web/lib/plasmic.css";
import projectcss from "./plasmic.module.css"; // plasmic-import: stpzpG5BNdyk25ngDDeBjt/projectcss
import sty from "./PlasmicProductCard.module.css"; // plasmic-import: cE6JLoNudm3H/css
    ...
    >
      ...
      >
        ...
        {(
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__isQvS, {
              [sty.freeBoxsmall__isQvS2Df6T]: hasVariant(
                $state,
                "small",
                "small"
              )
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__wTqe2, {
            [sty.freeBoxsmall__wTqe22Df6T]: hasVariant($state, "small", "small")
          })}
        >
          <div className={classNames(projectcss.all, sty.freeBox__t71J6)}>
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames(
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Rating
                  className={classNames("__wab_instance", sty.rating___7O4Lj)}
                />
              ),
          ...
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__sy9IK)}
          >
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
