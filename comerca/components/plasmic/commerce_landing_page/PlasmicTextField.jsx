...
import Label from "../../Label"; // plasmic-import: JuEnaEPMzDFs/component
import TextInput2 from "../../TextInput2"; // plasmic-import: vts_5IfhxgQJ/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: t-kRl-xhtUAw/component
import Description from "../../Description"; // plasmic-import: 2qGf9F30dZ1t/component
import "@plasmicapp/react-web/lib/plasmic.css";
import projectcss from "./plasmic.module.css"; // plasmic-import: stpzpG5BNdyk25ngDDeBjt/projectcss
import sty from "./PlasmicTextField.module.css"; // plasmic-import: uBdFadon0IvN/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__mzsEu, {
          [sty.freeBoxiconEnd__mzsEuoKdOb]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__mzsEuu0QL]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__mzsEur3Sss]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__zweaZ, {
            [sty.freeBoxiconStart__zweaZu0QL]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__zweaZr3Sss]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__b42SK)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__qn9Rr, {
            [sty.freeBoxiconEnd__qn9RrOKdOb]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__qn9RrU0QL]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__lQiw3)}
                role={"img"}
              />
            ),
